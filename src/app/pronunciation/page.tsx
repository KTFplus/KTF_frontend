    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800">
      <div className="container mx-auto max-w-4xl px-4 py-6 sm:py-12">
        <div className="mb-6 sm:mb-8">
          <Link
            href="/"
            className="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 text-sm sm:text-base text-gray-300 hover:text-white bg-zinc-800/50 rounded-lg shadow-sm hover:shadow transition-all duration-300 border border-gray-700"
          >
        ...
        <div className="bg-gray-800/50 rounded-xl sm:rounded-2xl shadow-lg border border-gray-700 hover:shadow-xl transition-shadow duration-300 backdrop-blur-sm p-4 sm:p-8">
